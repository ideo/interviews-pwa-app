...
var slick = createCommonjsModule(function (module, exports) {
  (function(factory) {
    ...
    Slick.prototype.slideHandler = function(index, sync, dontAnimate) {
      ...
      if(screen.availWidth > 991 && _.currentSlide === _.slideCount - 1) {
        slideLeft = slideLeft + 96;
      }

      if(screen.availWidth > 991 && _.currentSlide === _.slideCount - 1) {
        _.currentLeft = _.currentLeft + 96;
      }
    ...
    Slick.prototype.swipeMove = function(event) {
      ...
      if(screen.availWidth < 992 && _.currentSlide === 0) {
        _.swipeLeft = 0
      }
